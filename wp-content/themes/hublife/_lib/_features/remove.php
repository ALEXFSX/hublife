...
// define('NOCAT_URL', trailingslashit( get_stylesheet_directory_uri() . '/lib/no-category'));
// define('NOCAT_DIR', trailingslashit( STYLESHEETPATH . '/lib/no-category'));
