...
require_once locate_template('/_lib/_features/mobile-detector.php');//...DETECTA MOBILE
require_once locate_template('/_lib/_features/identifydevice.php');//...DETECTA MOBILE
...
//===================================INFORMACON============================================
// require_once locate_template('/_lib/_informacon/informacon.php');//....INFORMACON
//===================================API's===============================================
...
function tema_setup() {
  ...
  register_nav_menus(array(
    'menu_1' => 'Menu Topo Principal',
    'menu_2' => 'Menu Rodapé (Pontes)',
    'menu_3' => 'Menu Rodapé (Aplicativo)',
    'menu_4' => 'Menu Rodapé (Advogado)',
    //'menu_3' => 'Menu Topo mobile',
  ));
