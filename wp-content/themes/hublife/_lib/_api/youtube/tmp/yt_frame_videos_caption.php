...
echo '<div id="'.md5(uniqid(rand(), true)).'" class="youtube-search-list">';
    ...
    if($pages == 'true') :
        $new_itens = $itens - 1;
        echo '<div class="wrap-token"><button class="yt-more-videos btn-more" data-title="'.$title.'" data-like="'.$likes.'" data-caption="'.$caption.'" data-qtd="'. $new_itens .'" data-token="'.$yt_next.'">Carregar mais</button></div>';
    endif;
