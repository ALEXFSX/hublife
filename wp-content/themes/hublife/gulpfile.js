...
function sync() {
    browserSync.init({
        proxy: 'http://localhost:8888/hublife/',
        notify: true,
        port: 8888 // definido a porta 8000, por default a porta é a 3000
    })
...
gulp.task('build',gulp.series(clean,gulp.parallel(css,images,sprite,fonts,scripts)));
